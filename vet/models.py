...
class ClientesFamilia(models.Model):
    ...
    def _str_(self):
        return "PrimerApellido: {0} -> CuentaBanco: {1} -> telefono {2}".format(self.PrimerApellido, self.CuentaBanco, self.telefono)
...
class RelacionPersonasClientes(models.Model):
    ...
    def _str_(self):
        return "IDClientesFamilia: {0} ->IDPersona {1}".format(self.IDClientesFamilia, self.IDPersona)
...
class PacientesMascotas(models.Model):
    ...
    def _str_(self):
        return "IDClientesFamilia: {0} -> AliasMascota: {1} -> Especie: {2}".format(self.IDClientesFamilia, self.AliasMascota, self.Especie)
...
class Pesos(models.Model):
    ...
    def _str_(self):
        return "IDPacientesMascotas:{0} -> Peso: {1}".format(self.IDPacientesMascotas, self.Peso)